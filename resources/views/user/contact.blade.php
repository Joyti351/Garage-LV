...
<head>
	...
	<link rel="stylesheet" type="text/css" href="{{asset('garage/source/bootstrap-3.3.6-dist/css/bootstrap.css')}}">
	<link rel="stylesheet" type="text/css" href="{{asset('garage/source/font-awesome-4.5.0/css/font-awesome.css')}}">
	<link rel="stylesheet" type="text/css" href="{{asset('garage/style/slider.css')}}">
	<link rel="stylesheet" type="text/css" href="{{asset('garage/style/mystyle.css')}}">
	<link rel="stylesheet" type="text/css" href="{{asset('garage/style/contactstyle.css')}}">
</head>
<body>
<!-- Header -->
	...
	<nav class="topnavbar navbar-default topnav">
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand logo" href="#"><img src="{{asset('garage/image/logo1.png')}}" alt="logo"></a>
			</div>
		</div>
...
<div class="allcontain">
	<div class="contact">
		<div class="newslettercontent">
			<div class="leftside">
				<img id="image_border" src="{{asset('garage/image/border.png')}}" alt="border">
...
<script type="text/javascript" src="{{asset('garage/source/js/myscript.js')}}"></script> <script type="text/javascript" src="{{asset('garage/source/bootstrap-3.3.6-dist/js/bootstrap.js')}}"></script>
